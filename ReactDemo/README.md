# React Frontend Monitoring Demo
...
# 运行容器
docker run -p 18085:80 --name react-demo react-demo-app
...
```javascript
import './instrumentation.js'; // 必须在 React 应用之前
...
3. 搜索: `service.name="react-demo-app"`
4. 查看 Trace 瀑布图：

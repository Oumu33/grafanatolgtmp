...
const resource = new Resource({
  [SemanticResourceAttributes.SERVICE_NAME]: 'react-demo-app',
...
console.log('[OpenTelemetry] React 前端监控已初始化');
console.log('[OpenTelemetry] Service: react-demo-app');
